...
/* Message/data structure sizes */
#define FIDO2_AUTH_DATA_LENGTH		37	/* rpIdHash(32) + flags(1) + counter(4) */
#define FIDO2_ASSERTION_LENGTH		69	/* flags(1) + counter(4) + sig(64) */
#define FIDO2_CHALLENGE_MSG_LENGTH	34	/* version(1) + challenge(32) + opts(1) */
