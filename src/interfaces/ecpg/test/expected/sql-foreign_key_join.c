...
#line 44 "foreign_key_join.pgc"
  ...
  { ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "select t1 . c2 , t2 . c4 from t1 join t2 for key ( c3 ) -> t1 ( c1 )", ECPGt_EOIT, 
...
#line 52 "foreign_key_join.pgc"
  ...
  printf("  SELECT * FROM t1 JOIN t2 FOR KEY (c3) -> t1 (c1) -- ok (c2=%d, c4=%d)\n", c2, c4);

  /*comment*/{ ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "select t1 . c2 , t2 . c4 from t1 join t2 for key ( c3 ) -> t1 ( c1 )", ECPGt_EOIT, 
	ECPGt_int,&(c2),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(c4),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);
...
#line 57 "foreign_key_join.pgc"
  ...
  printf("  SELECT * FROM t1 JOIN t2 FOR KEY (c3) ->/*comment*/ t1 (c1) -- ok (c2=%d, c4=%d)\n", c2, c4);
...
#line 62 "foreign_key_join.pgc"
  ...
  /*comment*//*comment*/{ ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "select t1 . c2 , t2 . c4 from t1 join t2 for key ( c3 ) -> t1 ( c1 )", ECPGt_EOIT, 
	ECPGt_int,&(c2),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(c4),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);
...
#line 67 "foreign_key_join.pgc"
  ...
  printf("  SELECT * FROM t1 JOIN t2 FOR KEY (c3) /*comment*/->/*comment*/ t1 (c1) -- ok (c2=%d, c4=%d)\n", c2, c4);

  /* These should all parse successfully */
  printf("\nTesting valid <- syntax variations:\n");

  { ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "select t1 . c2 , t2 . c4 from t2 join t1 for key ( c1 ) < - t2 ( c3 )", ECPGt_EOIT, 
	ECPGt_int,&(c2),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(c4),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);
...
#line 75 "foreign_key_join.pgc"
  ...
  printf("  SELECT * FROM t2 JOIN t1 FOR KEY (c1) <- t2 (c3) -- ok (c2=%d, c4=%d)\n", c2, c4);

  /*comment*/{ ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "select t1 . c2 , t2 . c4 from t2 join t1 for key ( c1 ) < - t2 ( c3 )", ECPGt_EOIT, 
	ECPGt_int,&(c2),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(c4),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);
...
#line 80 "foreign_key_join.pgc"
  ...
  printf("  SELECT * FROM t2 JOIN t1 FOR KEY (c1) <-/*comment*/ t2 (c3) -- ok (c2=%d, c4=%d)\n", c2, c4);
...
#line 85 "foreign_key_join.pgc"
  ...
  /*comment*//*comment*/{ ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "select t1 . c2 , t2 . c4 from t2 join t1 for key ( c1 ) < - t2 ( c3 )", ECPGt_EOIT, 
	ECPGt_int,&(c2),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(c4),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);
...
#line 90 "foreign_key_join.pgc"
  ...
  printf("  SELECT * FROM t2 JOIN t1 FOR KEY (c1) /*comment*/<-/*comment*/ t2 (c3) -- ok (c2=%d, c4=%d)\n", c2, c4);
