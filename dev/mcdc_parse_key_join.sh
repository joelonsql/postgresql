...
Environment overrides:
  ...
  INJECTION_ISOLATION_TESTS="key_join_proof_race_operator_prelock key_join_proof_race_filter_operator_prelock key_join_proof_race_filter_function_prelock key_join_proof_race_function_prelock"
EOF
}
...
INJECTION_ISOLATION_TESTS=${INJECTION_ISOLATION_TESTS:-"key_join_proof_race_operator_prelock key_join_proof_race_filter_operator_prelock key_join_proof_race_filter_function_prelock key_join_proof_race_function_prelock"}
