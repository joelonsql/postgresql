...
pub extern fn pq_verify_peer_name_matches_certificate_name(conn: ?*PGconn, namedata: [*c]const u8, namelen: usize, store_name: [*c][*c]u8) c_int;
pub extern fn pq_verify_peer_name_matches_certificate_ip(conn: ?*PGconn, ipdata: [*c]const u8, iplen: usize, store_name: [*c][*c]u8) c_int;
pub extern fn pq_verify_peer_name_matches_certificate(conn: ?*PGconn) bool;
